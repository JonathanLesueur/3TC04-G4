 ...
 */
final class Version20210316010909 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD picture VARCHAR(255) NOT NULL, CHANGE type type ENUM(\'sale\', \'purchase\', \'service\', \'search\')');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE offer DROP picture, CHANGE type type VARCHAR(255) CHARACTER SET utf8mb4 DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
